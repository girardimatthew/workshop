...
// *********************************************************************************
// Modify such program so that when you enter an integer, the program will output
// all the names with that score or "score not found".
// *********************************************************************************
