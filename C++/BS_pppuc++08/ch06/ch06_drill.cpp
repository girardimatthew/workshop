...
//    You need to find and fix few bugs. Those bugs are not in the text book.
...
// 	Please enter expressions using floating-poin numbers."
// 5. Improve that greeting by mentioning which operators are available and how to 
//    print and exit
...
try
{
    ...
    cout << "To print enter '='.\n";
    cout << "Please enter expressions using floating-poin numbers.\n";
    while (cin) {
        Token t = ts.get();
