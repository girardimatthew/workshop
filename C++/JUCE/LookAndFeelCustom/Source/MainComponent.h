...
public:
                           ...
                           const float rotaryStartAngle, const float rotaryEndAngle, Slider& slider) override
    {
        ...
        Path p;
        const float pointerLength = radius / 2;  // * 0.33f;
        ...
        g.fillEllipse (rx + radius / 2 , ry + radius / 2 , rw - radius, rw - radius);
        
        // outline
        g.setColour (Colours::black);
        g.drawEllipse (rx + radius / 2 , ry + radius / 2 , rw - radius, rw - radius, 1.0f);
...
public:
    ...
    MainContentComponent()
    {
        ...
        // otherLookAndFeel.setColour (Slider::rotarySliderFillColourId, Colours::red);
